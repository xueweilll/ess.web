										...
										Ext
												.create(
														'Ext.Component', //此组件类似渲染一个DIV
														{
															...
															margins : '0 0 5 0',
															autoEl : {
																html : '<div style="background:url(image/top.jpg) no-repeat 0 0;height: 100px;background-size:100% 100%;"><div style="padding-top:10px;flaot:left"><img src="image/logo.png" /></div><div style="flaot:right;margin-right:10px;"></div></div>'
															}
														}),
										{
