...
public class CurrentIrData  implements Serializable{
	/** 
	* @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么) 
	*/ 
	private static final long serialVersionUID = -2060049038645142304L;
	private String id;
	private int dtuId;
	private int lmuId;
	...
	/*
	 * public String getLmuName() { return lmuName; } public void
	 * setLmuName(String lmuName) { this.lmuName = lmuName; }
	 */
