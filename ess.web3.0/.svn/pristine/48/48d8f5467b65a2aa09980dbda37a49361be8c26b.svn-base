...
public class IndexAction extends ActionBase {
	...
	ArrayList<PartSensor> dtuListMsg;
	
		

	public ArrayList<PartSensor> getDtuListMsg() {
		return dtuListMsg;
	}

	public void setDtuListMsg(ArrayList<PartSensor> dtuListMsg) {
		this.dtuListMsg = dtuListMsg;
	}
	...
	public String CurrentIrStore1() {
		dtuListMsg = currStore.CreateCurrIrData1(dtuId);
		return "success";
	}
