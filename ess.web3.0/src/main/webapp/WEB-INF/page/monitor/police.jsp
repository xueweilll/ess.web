...
<script type="text/javascript" src="js/model/curriritem.js"></script>
<script type="text/javascript" src="js/model/currhritem.js"></script>
<script type="text/javascript" src="js/model/hisalarmiritem.js"></script>
<script type="text/javascript" src="js/monitor/police.js"></script>
</head>
<body>
