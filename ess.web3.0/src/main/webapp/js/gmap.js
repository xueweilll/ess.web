...
Ext.onReady(function() {
	...
	data.addListener('load', function(st, rds, opts) {
		reload();
	});
	...
	Ext.create('Ext.container.Viewport', {
		...
		items : [{
					...
					region : 'center',
					  width: '100%',
					  height: '100%',
					  //html:'<div id="bb"  style="width:100%;height:100%;background:url(image/dapmap.png) no-repeat 0 0;background-size:100% 100%;position:relative;"></div>',
					  html:'<div id="bb"  style="width:100%;height:100%;background:url(image/dapmap.png) no-repeat 0 0;background-size:100% 100%;position:relative;"></div>',					  
