...
public class HttpClientUtil {
	...
	public static final String DEFAULT_PRE_URL = "http://192.168.1.26:82/webapi/service/"; //此处替换成平台SDK所在服务器IP与端口
	public static final String DEFAULT_APPKEY = "1349788c";//此处替换成申请的appkey
	public static final String DEFAULT_SECRET = "3c40e75f57c04f358a2542d12d5d7505";//此处替换成申请的secret
